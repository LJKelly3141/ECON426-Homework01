...
1. **Access the RStudio Cloud Project**
   Access the project via the link provided in Canvas.

2. **Open the Assignment File**
   Within the project, locate this Quarto file and follow the directions provided.

3. **Submission Instructions**
   After completing the case, render your file to produce an MS Word document (.docx). Submit this document to the Canvas Dropbox.
...
```
     *(Note: The file `cholesterol.csv` is in the data folder.)*
